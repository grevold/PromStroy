export const texts = {
  Slider: [
    {
      ...
      products: "Лист, Уголок, Полособульб с РРРС и РМРС",
      product_bg: "ShipboardSteel.png",
      icons: ["ShipboardSteel1.png", "ShipboardSteel2.png"],
    },
    {
      title: "Износостойкая сталь",
      marks: "Hardox, Sidur, Magstrong, Powerhard и др.",
      products:
    ...
    },
    {
      ...
      marks:
        "09Г2С, 10ХСНД, 17Г1С, 30ХГСА, 38ХА, 65Г, Х12МФ, Р18, 9ХС, ХВГ и др.",
    ...
    },
    {
      ...
      marks: "12Х18Н10Т, 08Х18Н10Т, 14Х17Н2, 06ХН28МДТ, AISI и др.",
      products:
    ...
    },
    {
      ...
      products:
        "Изделия общего (лист, круг, труба, уголок, шестигранник, проволока) и специального (припой, аноды, катоды, протекторы) назначения, редкие сплавы",
  ...
  Requisites: [
    ...
    {
      title: `Директор:`,
      text: `Борисенко Юрий Иванович, на основании Устава`,
    },
    {
      title: `Главный бухгалтер:`,
      text: `Смирнова Людмила Витальевна`,
    },
  ],
};
